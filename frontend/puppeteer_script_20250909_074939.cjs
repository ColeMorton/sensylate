...
(async () => {
  ...
  try {
    ...
    await page.screenshot({
      path: '/Users/colemorton/Projects/sensylate-command-system-enhancements/data/outputs/photo-booth/bitcoin_cycle_intelligence_light_16x9_png_300dpi_20250909_074939_temp.png',
      fullPage: false,
      type: 'png',
      quality: undefined
    });

    console.log('Screenshot saved to:', '/Users/colemorton/Projects/sensylate-command-system-enhancements/data/outputs/photo-booth/bitcoin_cycle_intelligence_light_16x9_png_300dpi_20250909_074939_temp.png');
