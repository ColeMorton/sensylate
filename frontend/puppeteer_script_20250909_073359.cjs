...
(async () => {
  ...
  try {
    ...
    console.log('Navigating to:', 'http://localhost:4321/photo-booth?dashboard=bitcoin_cycle_intelligence&mode=light&aspect_ratio=4:3');
    await page.goto('http://localhost:4321/photo-booth?dashboard=bitcoin_cycle_intelligence&mode=light&aspect_ratio=4:3', { waitUntil: 'networkidle0', timeout: 30000 });
    ...
    await page.screenshot({
      path: '/Users/colemorton/Projects/sensylate-command-system-enhancements/data/outputs/photo-booth/bitcoin_cycle_intelligence_light_4x3_png_300dpi_20250909_073359_temp.png',
      fullPage: false,
      type: 'png',
      quality: undefined
    });

    console.log('Screenshot saved to:', '/Users/colemorton/Projects/sensylate-command-system-enhancements/data/outputs/photo-booth/bitcoin_cycle_intelligence_light_4x3_png_300dpi_20250909_073359_temp.png');
