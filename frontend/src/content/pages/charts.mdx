...
<ChartDisplay
  ...
  description="Interactive chart showing Apple stock closing prices with current market data. Updated regularly from financial data sources."
  chartType="apple-price"
/>

<ChartDisplay
  client:only="react"
  title="Strategy Price"
  category="Reference Data"
  description="Interactive chart showing MicroStrategy stock closing prices with current market data. Updated regularly from financial data sources."
...
<ChartDisplay
  ...
  description="Percentage-based comparison of Chinese EV leaders XPeng (XPEV) and NIO over the past year. Both series normalized to show relative performance from the starting price."
