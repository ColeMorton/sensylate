...
import type { DashboardConfig, DashboardChart } from '@/services/dashboardLoader';
    ...
    charts: [
      {
        ...
        description: 'Multi-strategy Bitcoin trading vs buy-and-hold approach from 2014-2025',
...
// Test data factory
export const createMockDashboard = (overrides: Partial<DashboardConfig> = {}): DashboardConfig => ({
  ...mockPortfolioHistoryPortraitDashboard,
  ...overrides
});

export const createMockChart = (overrides: Partial<DashboardChart> = {}): DashboardChart => ({
  title: 'Test Chart',
