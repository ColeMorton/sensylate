...
export const btcPriceChartConfig: ChartConfig = {
  metadata: {
    ...
    description:
      "Interactive Bitcoin (BTC-USD) price chart showing the last 210 days of market data. Displays daily open, high, low, close prices with volume data for cycle intelligence analysis.",
    chartType: "btc-price",
  },
  dataRequirements: {
