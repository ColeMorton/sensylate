...
(async () => {
  ...
  try {
    ...
    console.log('Navigating to:', 'http://localhost:4321/photo-booth?dashboard=fundamental_analysis&mode=light&aspect_ratio=3:4');
    await page.goto('http://localhost:4321/photo-booth?dashboard=fundamental_analysis&mode=light&aspect_ratio=3:4', { waitUntil: 'networkidle0', timeout: 30000 });
    ...
    await page.screenshot({
      path: '/Users/colemorton/Projects/sensylate-command-system-enhancements/data/outputs/photo-booth/fundamental_analysis_light_3x4_png_300dpi_20250909_073302_temp.png',
      fullPage: false,
      type: 'png',
      quality: undefined
    });

    console.log('Screenshot saved to:', '/Users/colemorton/Projects/sensylate-command-system-enhancements/data/outputs/photo-booth/fundamental_analysis_light_3x4_png_300dpi_20250909_073302_temp.png');
