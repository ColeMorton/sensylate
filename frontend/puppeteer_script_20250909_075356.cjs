...
(async () => {
  ...
  try {
    ...
    await page.screenshot({
      path: '/Users/colemorton/Projects/sensylate-command-system-enhancements/data/outputs/photo-booth/fundamental_analysis_light_3x4_png_300dpi_20250909_075356_temp.png',
      fullPage: false,
      type: 'png',
      quality: undefined
    });

    console.log('Screenshot saved to:', '/Users/colemorton/Projects/sensylate-command-system-enhancements/data/outputs/photo-booth/fundamental_analysis_light_3x4_png_300dpi_20250909_075356_temp.png');
