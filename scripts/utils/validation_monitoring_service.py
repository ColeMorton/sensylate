...
class ValidationMonitoringService:
    ...
    def track_validation_event(self, validation_result) -> None:
        ...
        try:
            ...
            event = ValidationEvent(
                ...
                critical_issues_count=len([i for i in validation_result.real_time_validation.issues 
    ...
    def _update_statistics(self, event: ValidationEvent) -> None:
        ...
        self.statistics['average_validation_time_seconds'] = (
            (current_avg_time * (total - 1) + event.validation_time_seconds) / total
        )
    ...
    def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        return {
            'validation_performance': {
                ...
                'p95_time_seconds': sorted(validation_times)[int(len(validation_times) * 0.95)] if validation_times else 0
            },
            'data_freshness': {
