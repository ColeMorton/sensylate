        ...
        return {
            ...
            "validation_suites": [
                ...
                },
                {
                    ...
                    "validators": ["path_consistency", "schema_structure", "template_structure", "command_integrity"],
                    "required_score": 0.8,
                    "fail_fast": False,
                    "timeout_minutes": 5
                },
                {
                    ...
                    "validators": ["comprehensive_system", "quality_standards", "execution_integrity"],
                    "required_score": 0.85,
                    "fail_fast": False,
                    "timeout_minutes": 10
                },
                {
                    ...
                    "validators": ["comprehensive_system", "performance_regression", "drift_detection"],
                    "required_score": 0.9,
                    "fail_fast": False,
                    "timeout_minutes": 15
                }
...
def main():
    ...
    parser.add_argument('--suite', choices=['pre_commit', 'pull_request', 'main_branch', 'nightly'],
    ...
    parser.add_argument('--list-suites', action='store_true',
                       help='List available validation suites')
