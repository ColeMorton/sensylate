...
class PathSynchronizer:
    ...
    def _generate_fix(self, original: str, issue_type: str) -> str:
        ...
        if issue_type in ['hardcoded', 'hardcoded_backtick', 'hardcoded_quoted', 'hardcoded_single_quoted']:
...
def main():
    ...
    parser.add_argument('--scan', action='store_true',
                       help='Scan for path issues (dry-run)')
    parser.add_argument('--fix', action='store_true',
                       help='Apply fixes to path issues')
    parser.add_argument('--validate', action='store_true',
                       help='Quick validation check (returns exit code)')
    parser.add_argument('--pattern', default='*.txt',
                       help='File pattern to scan (default: *.txt)')
