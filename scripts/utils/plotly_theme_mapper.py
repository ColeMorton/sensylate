...
class PlotlyThemeMapper:
    ...
    def get_template_name(self, mode: str = "light", 
                         high_dpi: bool = False,
    ...
    def apply_template(self, fig: go.Figure, 
                      mode: str = "light",
                      high_dpi: bool = False,
                      dashboard: bool = False) -> go.Figure:
        """
...
class MultiFormatExporter:
    ...
    def create_export_batch(self, 
                          figures: Dict[str, go.Figure],
                          output_dir: str,
                          formats: List[str] = None,
                          high_dpi: bool = True,
                          mode: str = "light") -> Dict[str, Dict[str, str]]:
        """
