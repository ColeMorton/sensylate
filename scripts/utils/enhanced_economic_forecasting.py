...
class EconomicForecastingEngine:
    ...
    def generate_enhanced_forecasts(self, discovery_data: Dict[str, Any], 
    ...
    def _extract_current_indicators(self, discovery_data: Dict, analysis_data: Dict) -> Dict[str, Any]:
        ...
        # Inflation data
        inflation_data = discovery_data.get("cli_comprehensive_analysis", {}).get(
            "central_bank_economic_data", {}).get("inflation_data", {})
        ...
        # Policy rate
        policy_data = discovery_data.get("cli_comprehensive_analysis", {}).get(
            "central_bank_economic_data", {}).get("monetary_policy_data", {})
        ...
        recession_prob = discovery_data.get("economic_indicators", {}).get(
            "composite_scores", {}).get("recession_probability", 0.25)
    ...
    def _generate_bear_scenario(self, indicators: Dict[str, Any], recession_prob: float) -> Dict[str, List[float]]:
        ...
        for quarter, (gdp, unemployment, inflation, policy_rate) in enumerate(zip(
            ...
            if quarter < 4:
                ...
                unemployment_path.append(round(max(unemployment_recovery, indicators["natural_unemployment"] - 1.0), 2))
    ...
    def _calculate_probabilistic_outcomes(self, scenario_forecasts: Dict[str, Any]) -> Dict[str, Any]:
        ...
        indicators = ["gdp_growth", "unemployment_rate", "inflation_rate", "policy_rate"]
        ...
        for indicator in indicators:
            ...
            for quarter in range(self.forecast_horizon):
                ...
                weights = [self.scenario_weights["base"], self.scenario_weights["bear"], self.scenario_weights["bull"]]
    ...
    def _calculate_scenario_dispersion(self, base_path: List[float], 
                                     bear_path: List[float], 
                                     bull_path: List[float]) -> Dict[str, float]:
    ...
    def _project_consumer_expectations(self, indicators: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "employment_expectations": "improving" if indicators["unemployment_rate"] < indicators["natural_unemployment"] else "stable",
            "confidence": 0.78
        }
    ...
    def _simulate_policy_impacts(self, indicators: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "policy_coordination": {
                "monetary_fiscal_alignment": "supportive" if indicators["inflation_rate"] < indicators["inflation_target"] + 1.0 else "conflicted",
    ...
    def _calculate_forecast_confidence(self, indicators: Dict[str, Any], 
                                     scenario_forecasts: Dict[str, Any]) -> float:
    ...
    def _create_forecast_summary(self, scenario_forecasts: Dict[str, Any],
                               probabilistic_outcomes: Dict[str, Any],
                               forward_indicators: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "risk_assessment": {
                "upside_risks": ["Productivity acceleration", "Consumer resilience", "Policy coordination"],
                "downside_risks": ["Recession materialization", "Policy errors", "External shocks"],
                "key_monitoring_indicators": ["Leading composite index", "Financial conditions", "Consumer expectations"]
            },
            "policy_implications": [
    ...
    sample_discovery = {
        "cli_comprehensive_analysis": {
            "central_bank_economic_data": {
                ...
                "inflation_data": {
                    "cpi_data": {
                        "observations": [{"value": 2.8}]
                    }
                },
                "monetary_policy_data": {
                    "fed_funds_rate": {
                        "current_rate": {"value": 4.5}
                    }
                }
            }
        },
