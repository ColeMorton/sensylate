...
class GeopoliticalRiskEngine:
    ...
    def __init__(self, region: str = "US"):
        ...
        self.risk_categories = {
            'trade_tensions': {
                ...
                'economic_channels': ['trade_flows', 'supply_chains', 'investment', 'sentiment'],
                'typical_duration': 24  # months
            },
            'sanctions': {
                'base_probability': 0.3,
                'severity_multiplier': 1.8,
                'economic_channels': ['financial_flows', 'commodity_prices', 'trade_flows'],
                'typical_duration': 36
            },
            'military_conflict': {
                'base_probability': 0.15,
                'severity_multiplier': 2.5,
                'economic_channels': ['commodity_prices', 'safe_haven_flows', 'supply_chains', 'sentiment'],
                'typical_duration': 12
            },
            'policy_uncertainty': {
            ...
            'cyber_warfare': {
                ...
                'economic_channels': ['financial_infrastructure', 'supply_chains', 'sentiment'],
                'typical_duration': 6
            },
            'energy_disruption': {
    ...
    def analyze_geopolitical_risks(self, discovery_data: Dict[str, Any], 
    ...
    def _extract_geopolitical_context(self, discovery_data: Dict, analysis_data: Dict) -> Dict[str, Any]:
        ...
        return {
            ...
            "current_safe_haven_flows": "high" if market_stress > 0.6 else "moderate" if market_stress > 0.3 else "low"
        }
    ...
    def _assess_currency_stress(self, currency_dynamics: Dict) -> float:
        ...
        flow_stress = {"inflow_pressures": 0.3, "neutral": 0.4, "outflow_pressures": 0.8}.get(capital_flows, 0.4)
    ...
    def _assess_commodity_stress(self, energy_data: Dict) -> float:
        ...
        balance_stress = {"oversupply": 0.2, "balanced": 0.3, "tight": 0.6, "shortage": 0.9}.get(balance, 0.3)
        ...
        storage_stress = {"abundant": 0.1, "adequate": 0.3, "tight": 0.7, "critical": 0.9}.get(storage_status, 0.3)
    ...
    def _calculate_economic_impacts(self, active_risks: Dict[str, Any], 
        ...
        for risk_name, risk_data in active_risks.items():
            ...
            for channel in economic_channels:
                if channel in self.transmission_channels:
                    ...
                    severity_multiplier = {"low": 0.5, "moderate": 1.0, "high": 1.5, "extreme": 2.0}[severity]
    ...
    def _analyze_contagion_risks(self, active_risks: Dict[str, Any], 
                                context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for risk_name, risk_data in active_risks.items():
                ...
                if source_region in self.contagion_matrix:
                    for target_region, contagion_coeff in self.contagion_matrix[source_region].items():
                        if target_region not in affected_regions:  # Not already affected
                            ...
                            contagion_map[target_region]["transmission_channels"] = list(set(
            ...
            contagion_assessments[risk_name] = {
                ...
                "overall_contagion_risk": "high" if any(
    ...
    def _generate_risk_scenarios(self, active_risks: Dict[str, Any], 
                                economic_impacts: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _calculate_aggregate_impact(self, active_risks: Dict[str, Any], 
                                   economic_impacts: Dict[str, Any], 
                                   scenario_multiplier: float) -> Dict[str, float]:
        ...
        for risk_name, impact_data in economic_impacts.items():
            if risk_name in active_risks:
                ...
                total_inflation_impact += impact_data["inflation_impact_percentage_points"] * probability * scenario_multiplier
    ...
    def _calculate_geopolitical_risk_index(self, active_risks: Dict[str, Any], 
                                          economic_impacts: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for risk_name, risk_data in active_risks.items():
            ...
            severity_scores = {"low": 0.25, "moderate": 0.5, "high": 0.75, "extreme": 1.0}
    ...
    def _generate_investment_implications(self, active_risks: Dict[str, Any],
                                        economic_impacts: Dict[str, Any],
                                        contagion_analysis: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _calculate_allocation_adjustments(self, active_risks: Dict[str, Any], 
                                        economic_impacts: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _determine_regional_positioning(self, active_risks: Dict[str, Any],
                                      contagion_analysis: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "safe_haven_preferences": ["US", "EU"] if "US" in regional_recommendations and regional_recommendations["US"]["risk_exposure_score"] < 0.4 else ["US"],
            "highest_risk_regions": [
                region for region, data in regional_recommendations.items() 
                if data["risk_exposure_score"] > 0.6
            ]
        }
        
    def _calculate_regional_risk_exposure(self, region: str, active_risks: Dict[str, Any],
                                        contagion_analysis: Dict[str, Any]) -> float:
    ...
    def _analyze_sector_implications(self, active_risks: Dict[str, Any],
                                   economic_impacts: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for sector, sensitivities in sector_sensitivities.items():
            ...
            sector_impacts[sector] = {
                ...
                "investment_recommendation": "overweight" if sector_impact > 0.2 else "underweight" if sector_impact < -0.3 else "neutral"
            }
            
        return sector_impacts
        
    def _recommend_hedging_strategies(self, active_risks: Dict[str, Any],
                                    economic_impacts: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "energy_disruption" in active_risks:
            hedging_strategies.append({
                ...
                "instruments": ["energy_ETFs", "commodity_futures", "energy_stocks"],
        ...
        return {
            ...
            "rebalancing_triggers": ["geopolitical_risk_index > 70", "new_major_geopolitical_event"],
            "monitoring_indicators": ["VIX", "USD_index", "commodity_prices", "credit_spreads"]
        }
        
    def _create_positioning_summary(self, allocation_adjustments: Dict[str, Any],
                                  regional_positioning: Dict[str, Any],
                                  sector_implications: Dict[str, Any]) -> Dict[str, Any]:
        ...
        negative_sectors = [s for s, data in sector_implications.items() 
    ...
    def _create_integrated_assessment(self, active_risks: Dict[str, Any],
                                    economic_impacts: Dict[str, Any],
                                    contagion_analysis: Dict[str, Any],
                                    gpr_index: Dict[str, Any]) -> Dict[str, Any]:
        ...
        severe_impacts = [name for name, data in economic_impacts.items() 
                         if abs(data["gdp_impact_percentage_points"]) > 0.5]
        if severe_impacts:
            findings.append(f"Severe economic impact potential: {', '.join(severe_impacts)}")
            
        high_contagion = [name for name, data in contagion_analysis.items() 
