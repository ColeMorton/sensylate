...
class JSONSchemaGenerator:
    ...
    def _generate_monthly_performance_schema(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "required": ["month", "year", "trades", "win_rate", "return_pct", "market_condition"],
    ...
    def _generate_trade_data_schema(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "required": ["ticker", "entry_date", "exit_date", "duration", "return_pct", "quality"],
            "additionalProperties": False
        }
            ...
            "properties": {
                ...
                "layout": {
                    ...
                    "properties": {
                        ...
                        "bar_spacing": {"type": "number", "minimum": 0, "maximum": 1, "default": 0.1}
                    }
                },
                "styling": {
                    "type": "object",
                    "properties": {
                        "opacity": {"type": "number", "minimum": 0, "maximum": 1, "default": 0.8},
                        "border_width": {"type": "number", "minimum": 0, "default": 1},
                        "text_threshold": {"type": "number", "default": 5.0},
                        "gradient_intensity": {"type": "number", "minimum": 0, "maximum": 1, "default": 0.3}
                    }
                },
            ...
            "properties": {
                ...
                "layout": {
                    ...
                    "properties": {
                        ...
                        "donut_hole_size": {"type": "number", "minimum": 0, "maximum": 0.9, "default": 0.4}
                    }
                },
                "styling": {
                    "type": "object",
                    "properties": {
                        "pull_effect": {"type": "number", "minimum": 0, "maximum": 0.3, "default": 0.05},
                        "text_font_size": {"type": "integer", "minimum": 8, "default": 12},
        ...
        return {
            ...
            "properties": {
                ...
                "styling": {
                    "type": "object",
                    "properties": {
                        "bar_opacity": {"type": "number", "minimum": 0, "maximum": 1, "default": 0.8},
                ...
                "scalability": {
                    ...
                    "properties": {
                        ...
                        "volume_threshold": {"type": "integer", "minimum": 1, "default": 100}
                    }
                },
                "export": {"$ref": "#/$defs/ExportConfig"}
            },
        ...
        return {
            ...
            "properties": {
                ...
                "styling": {
                    "type": "object",
                    "properties": {
                        "base_marker_size": {"type": "number", "minimum": 5, "default": 15},
                        "size_scaling_factor": {"type": "number", "minimum": 1, "default": 20},
                        "opacity": {"type": "number", "minimum": 0, "maximum": 1, "default": 0.8},
                        "border_width": {"type": "number", "minimum": 0, "default": 0.8}
                    }
                },
                "clustering": {
                    "type": "object",
                    "properties": {
                        ...
                        "volume_threshold": {"type": "integer", "minimum": 50, "default": 100}
                    }
                },
                "export": {"$ref": "#/$defs/ExportConfig"}
            },
        ...
        return {
            ...
            "properties": {
                ...
                "spacing": {
                    "type": "object",
                    "properties": {
                        "horizontal": {"type": "number", "minimum": 0, "maximum": 1, "default": 0.15},
                        "vertical": {"type": "number", "minimum": 0, "maximum": 1, "default": 0.1}
                    }
                },
                "figure_size": {
                    "type": "array",
                ...
                "components": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            "name": {"type": "string"},
                            "type": {"type": "string", "enum": ["chart", "metrics", "text"]},
                            "position": {
                                "type": "array",
    ...
    def _generate_theme_config_schema(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                ...
                "template": {
                    "type": "string",
                    "enum": ["sensylate_light", "sensylate_dark", "sensylate_light_hd", "sensylate_dark_hd", "sensylate_dashboard"],
                ...
                "typography": {
                    "type": "object",
                    "properties": {
                        "font_family": {"type": "string", "default": "Heebo, sans-serif"},
                        "font_sizes": {
                            "type": "object",
                            "properties": {
                                "title": {"type": "integer", "minimum": 8, "default": 20},
                                "subtitle": {"type": "integer", "minimum": 8, "default": 16},
                                "body": {"type": "integer", "minimum": 8, "default": 12},
                                "axis_labels": {"type": "integer", "minimum": 6, "default": 10}
                            }
                        }
                    }
                },
            ...
            "properties": {
                ...
                "quality": {
                    ...
                    "properties": {
                        ...
                        "scale": {"type": "number", "minimum": 0.5, "maximum": 5, "default": 2},
                        "dpi_equivalent": {"type": "integer", "minimum": 72, "default": 192}
                    }
                },
                "output": {
                    "type": "object",
                    "properties": {
                        "directory": {"type": "string", "default": "data/outputs/charts"},
                        "filename_pattern": {"type": "string", "default": "{chart_type}_{timestamp}"},
