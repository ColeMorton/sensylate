...
class LayoutManager:
    ...
    def apply_responsive_font_sizing(self, ax: plt.Axes, base_size: int = 10) -> None:
        ...
        # Title sizing is now handled by theme_manager - don't override
...
if __name__ == "__main__":
    ...
    test_config = {
        "layout": {
            ...
            "spacing": {"horizontal": 0.2, "vertical": 0.3, "padding": 0.05},
        }
    }
