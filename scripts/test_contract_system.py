...
os.environ['DATA_OUTPUTS_PATH'] = '/Users/colemorton/Projects/sensylate-command-system-enhancements/data/outputs'
os.environ['TEMPLATES_PATH'] = '/Users/colemorton/Projects/sensylate-command-system-enhancements/templates'
...
print(f"   ✅ NumPy int64 overflow issue resolved")
