...
def test_matplotlib_wrapper():
    ...
    if isinstance(generator, AbstractChartGenerator):
        ...
        print("  ✗ MatplotlibChartGenerator does not inherit from AbstractChartGenerator")
        return False
...
def test_factory_pattern():
    ...
    plotly_gen = ChartGeneratorFactory.create_chart_generator(
        "plotly", theme_manager
    )
