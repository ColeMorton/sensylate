...
def main():
    ...
    comparison_framework = ChartComparisonFramework("data/outputs/phase3_visual_comparisons")
    ...
    print(f"📊 Testing with {len(small_trades)} small trades and {len(medium_trades)} medium trades")
    ...
    if results:
        ...
        avg_similarity = sum(r["similarity_metrics"]["similarity_percent"] for r in results) / len(results)
