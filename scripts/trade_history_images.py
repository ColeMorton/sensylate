...
class TradeHistoryImageGenerator:
    ...
    def generate_images_for_date(self, date_str: str, report_type: Optional[str] = None) -> List[Path]:
        """
    ...
    def _discover_reports(self, date_str: str, report_type: Optional[str] = None) -> List[Path]:
        """
