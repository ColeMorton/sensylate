...
class StrategyAnalysisScript(BaseScript):
    ...
    def execute(
        ...
        **kwargs
        ...
        try:
            # Validate inputs
            self.validate_inputs(ticker=ticker, strategy_name=strategy_name, date=date, 
            ...
            self.logger.log_error(
                e,
                {"ticker": ticker, "strategy_name": strategy_name, "date": date, "processing_time": processing_time}
            )
    ...
    def _load_strategy_data(self, ticker: str, strategy_name: str, date: str, data_path: Optional[str] = None) -> Dict[str, Any]:
    ...
    def _validate_performance_threshold(self, strategy_data: Dict[str, Any], threshold: float) -> None:
        ...
        if not performance_found:
            raise ValidationError(
                ...
                context={"available_fields": list(strategy_data.keys()), "required_metrics": performance_metrics}
            )
    ...
    def _save_content(self, content: str, ticker: str, strategy_name: str, date: str, output_path: Optional[str] = None) -> Path:
    ...
    def get_strategy_performance_summary(self, ticker: str, strategy_name: str, date: str, data_path: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            performance_metrics = {}
            for metric in ["win_rate", "net_performance", "total_trades", "reward_risk", "sharpe_ratio", "max_drawdown"]:
                if metric in strategy_data:
    ...
    def validate_strategy_data_quality(self, ticker: str, strategy_name: str, date: str, data_path: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            performance_fields = ["win_rate", "net_performance", "total_trades", "reward_risk"]
            ...
            for field, value in strategy_data.items():
                if field in ["win_rate", "net_performance", "reward_risk", "sharpe_ratio"] and not isinstance(value, (int, float)):
            ...
            return {
                ...
                "recommendations": self._generate_data_quality_recommendations(missing_fields, available_performance, type_issues)
            }
    ...
    def _generate_data_quality_recommendations(self, missing_fields: List[str], available_performance: List[str], type_issues: List[str]) -> List[str]:
        ...
        if len(available_performance) < 2:
            recommendations.append("Include more performance metrics (win_rate, net_performance, reward_risk, total_trades)")
