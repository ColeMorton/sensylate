...
class FundamentalAnalysisScript(BaseScript):
    ...
    def execute(
        ...
        **kwargs
        ...
        try:
            # Validate inputs
            self.validate_inputs(ticker=ticker, date=date, data_path=data_path, 
            ...
            self.logger.log_error(
                e,
                {"ticker": ticker, "date": date, "processing_time": processing_time}
            )
    ...
    def _load_analysis_data(self, ticker: str, date: str, data_path: Optional[str] = None) -> Dict[str, Any]:
    ...
    def _save_content(self, content: str, ticker: str, date: str, output_path: Optional[str] = None) -> Path:
    ...
    def preview_template_selection(self, ticker: str, date: str, data_path: Optional[str] = None) -> Dict[str, Any]:
