...
def load_schema():
    ...
    schema_path = Path(__file__).parent / "schemas" / "sector_analysis_discovery_schema.json"
...
def main():
    ...
    discovery_dir = Path(__file__).parent.parent / "data" / "outputs" / "sector_analysis" / "discovery"
    test_files = [
