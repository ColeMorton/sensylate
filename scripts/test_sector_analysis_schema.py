...
def load_schema():
    ...
    schema_path = Path(__file__).parent / "schemas" / "sector_analysis_analysis_schema.json"
...
def main():
    ...
    analysis_dir = Path(__file__).parent.parent / "data" / "outputs" / "sector_analysis" / "analysis"
    test_files = [
