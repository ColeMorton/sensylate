...
def analyze_institutional_quality(analysis_data, file_name):
    ...
    if "analysis_quality_assessment" in analysis_data:
        ...
        quality_metrics["overall_confidence"] = quality_assess.get("overall_confidence", quality_metrics["overall_confidence"])
...
def print_quality_assessment(metrics, file_name):
    ...
    print(f"  📊 Institutional Trading Quality Assessment:")
