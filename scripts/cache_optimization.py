            ...
            for cache_file in cache_files:
                try:
                    ...
                    if timestamp:
                        ...
                        if age_hours > 24:
                            analysis["expiration_analysis"]["expired_24h"] = analysis["expiration_analysis"].get("expired_24h", 0) + 1
                        elif age_hours > 4:
                            analysis["expiration_analysis"]["expired_4h"] = analysis["expiration_analysis"].get("expired_4h", 0) + 1
                        else:
                            analysis["expiration_analysis"]["fresh"] = analysis["expiration_analysis"].get("fresh", 0) + 1
