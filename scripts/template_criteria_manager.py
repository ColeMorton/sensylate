...
class CriteriaProfile:
    ...
    def get_requirements_for_template(self, template_name: str) -> Optional[TemplateRequirement]:
...
class TemplateCriteriaManager:
    ...
    def _load_default_criteria(self) -> None:
        ...
        strategy_profile.template_requirements["default"] = TemplateRequirement(
            ...
            optional_fields=["win_rate", "net_performance", "reward_risk", "total_trades"],
            validation_rules={
        ...
        sector_profile = CriteriaProfile(
            name="sector_default",
            content_type="sector"
        )
    ...
    def get_template_requirements(self, content_type: str, template_name: str) -> Optional[TemplateRequirement]:
    ...
    def update_template_requirements(self, content_type: str, template_name: str, requirements: TemplateRequirement) -> None:
    ...
    def export_criteria_configuration(self, output_path: Path) -> None:
        ...
        config_data = {
            ...
            "export_timestamp": self.logger.logger.handlers[0].formatter.formatTime(None, None)
            if self.logger.logger.handlers else "unknown"
        }
