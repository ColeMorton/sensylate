        ...
        metric_positions = [
            {
                "x": 0.125,
                "title": "Win Rate",
                "value": f"{getattr(metrics, 'win_rate', 0):.1f}%",
                "color": "#26c6da",
            },
            {
                "x": 0.375,
            ...
            },
            {
                "x": 0.625,
                "title": "Profit Factor",
                "value": f"{getattr(metrics, 'profit_factor', 0):.2f}",
                "color": "#7e57c2",
            },
            {
                "x": 0.875,
                "title": "Total Trades",
                "value": f"{getattr(metrics, 'total_trades', 0)}",
                "color": "#3179f5",
            },
        ]
    ...
    def _add_monthly_performance(
        ...
        if not monthly_data:
            fig.add_annotation(
                ...
                yref="paper",
                x=0.25,
                y=0.6,  # Approximate position for top-left chart
                showarrow=False,
                font=dict(size=12),
            )
            return
    ...
    def _add_quality_distribution(
        ...
        if not quality_data:
            ...
            fig.add_annotation(
                ...
                yref="paper",
                x=0.75,
                y=0.6,  # Approximate position for top-right chart
                showarrow=False,
                font=dict(size=12),
            )
            return
    ...
    def _add_trade_performance(
        ...
        if not trades:
            fig.add_annotation(
                ...
                yref="paper",
                x=0.25,
                y=0.25,  # Approximate position for bottom-left chart
                showarrow=False,
                font=dict(size=12),
            )
            return
    ...
    def _add_duration_scatter(
        ...
        if not trades:
            fig.add_annotation(
                ...
                yref="paper",
                x=0.75,
                y=0.25,  # Approximate position for bottom-right chart
                showarrow=False,
                font=dict(size=12),
            )
            return
