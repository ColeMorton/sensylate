...
def test_configuration():
    ...
    try:
        ...
        required_keys = ["default_dashboard", "active_dashboards", "screenshot_settings", "output"]
...
def test_page_files():
    ...
    # Check photo booth page
    page_path = project_root / "frontend/src/content/pages/photo-booth.mdx"
