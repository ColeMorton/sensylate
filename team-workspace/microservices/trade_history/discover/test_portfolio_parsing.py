...
def parse_portfolio_parameter(portfolio: str, data_dir: str = "/Users/colemorton/Projects/sensylate/data/raw/trade_history/") -> Tuple[bool, str, Optional[str]]:
    """
...
def validate_discovery_schema():
    ...
    try:
        ...
        required_props = ["portfolio", "discovery_metadata", "authoritative_trade_data", "data_quality_assessment"]
