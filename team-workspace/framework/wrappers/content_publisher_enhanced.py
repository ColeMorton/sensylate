#!/usr/bin/env python3
"""
Enhanced content_publisher Command Wrapper
Integrates Universal Evaluation Framework with content_publisher command
"""
...
class EnhancedContentpublisherCommand:
    """Enhanced content_publisher command with Universal Evaluation integration"""

    def __init__(self, workspace_path: str = None):
        self.command_name = "content_publisher"
    ...
    def execute_with_evaluation(self, **kwargs) -> dict:
        """Execute content_publisher with full Universal Evaluation"""
    ...
    def _execute_original_command(self, **kwargs) -> dict:
        """Execute original content_publisher command logic"""
    ...
    def _load_evaluation_manifest(self) -> dict:
        ...
        manifest_file = Path(".claude/commands/content_publisher.eval.yaml")
    ...
    def _load_dependency_manifest(self) -> dict:
        ...
        manifest_file = Path(".claude/commands/content_publisher.deps.yaml")
        if manifest_file.exists():
            with open(manifest_file, 'r') as f:
                return yaml.safe_load(f)
        return {}
...
def main():
    """Execute enhanced content_publisher command"""
    enhanced_command = EnhancedContentpublisherCommand()
