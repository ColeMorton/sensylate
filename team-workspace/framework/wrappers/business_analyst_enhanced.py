#!/usr/bin/env python3
"""
Enhanced business_analyst Command Wrapper
Integrates Universal Evaluation Framework with business_analyst command
"""
...
class EnhancedBusinessanalystCommand:
    """Enhanced business_analyst command with Universal Evaluation integration"""

    def __init__(self, workspace_path: str = None):
        self.command_name = "business_analyst"
    ...
    def execute_with_evaluation(self, **kwargs) -> dict:
        """Execute business_analyst with full Universal Evaluation"""
    ...
    def _execute_original_command(self, **kwargs) -> dict:
        """Execute original business_analyst command logic"""
    ...
    def _load_evaluation_manifest(self) -> dict:
        ...
        manifest_file = Path(".claude/commands/business_analyst.eval.yaml")
    ...
    def _load_dependency_manifest(self) -> dict:
        ...
        manifest_file = Path(".claude/commands/business_analyst.deps.yaml")
        if manifest_file.exists():
            with open(manifest_file, 'r') as f:
                return yaml.safe_load(f)
        return {}
...
def main():
    """Execute enhanced business_analyst command"""
    enhanced_command = EnhancedBusinessanalystCommand()
