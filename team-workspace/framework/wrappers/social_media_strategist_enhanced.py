#!/usr/bin/env python3
"""
Enhanced social_media_strategist Command Wrapper
Integrates Universal Evaluation Framework with social_media_strategist command
"""
...
class EnhancedSocialmediastrategistCommand:
    """Enhanced social_media_strategist command with Universal Evaluation integration"""

    def __init__(self, workspace_path: str = None):
        self.command_name = "social_media_strategist"
    ...
    def execute_with_evaluation(self, **kwargs) -> dict:
        """Execute social_media_strategist with full Universal Evaluation"""
    ...
    def _execute_original_command(self, **kwargs) -> dict:
        """Execute original social_media_strategist command logic"""
    ...
    def _load_evaluation_manifest(self) -> dict:
        ...
        manifest_file = Path(".claude/commands/social_media_strategist.eval.yaml")
    ...
    def _load_dependency_manifest(self) -> dict:
        ...
        manifest_file = Path(".claude/commands/social_media_strategist.deps.yaml")
        if manifest_file.exists():
            with open(manifest_file, 'r') as f:
                return yaml.safe_load(f)
        return {}
...
def main():
    """Execute enhanced social_media_strategist command"""
    enhanced_command = EnhancedSocialmediastrategistCommand()
