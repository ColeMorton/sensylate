#!/usr/bin/env python3
"""
Enhanced content_evaluator Command Wrapper
Integrates Universal Evaluation Framework with content_evaluator command
"""
...
class EnhancedContentevaluatorCommand:
    """Enhanced content_evaluator command with Universal Evaluation integration"""

    def __init__(self, workspace_path: str = None):
        self.command_name = "content_evaluator"
    ...
    def execute_with_evaluation(self, **kwargs) -> dict:
        """Execute content_evaluator with full Universal Evaluation"""
    ...
    def _execute_original_command(self, **kwargs) -> dict:
        """Execute original content_evaluator command logic"""
    ...
    def _load_evaluation_manifest(self) -> dict:
        ...
        manifest_file = Path(".claude/commands/content_evaluator.eval.yaml")
    ...
    def _load_dependency_manifest(self) -> dict:
        ...
        manifest_file = Path(".claude/commands/content_evaluator.deps.yaml")
        if manifest_file.exists():
            with open(manifest_file, 'r') as f:
                return yaml.safe_load(f)
        return {}
...
def main():
    """Execute enhanced content_evaluator command"""
    enhanced_command = EnhancedContentevaluatorCommand()
