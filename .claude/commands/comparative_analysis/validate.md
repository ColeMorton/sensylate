...
**Output Location**: `./data/outputs/comparative_analysis/validation/`
...
- **Validation Standards**: `./data/outputs/comparative_analysis/MU_vs_DHR_20250730.md` (quality benchmark template)
